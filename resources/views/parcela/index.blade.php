          ...
          <div class="col-sm-12">
            <div class="row">
              <div class="col-sm-3 form-group">
                ...
                <input type='text' name="" class="form-control money text-right" id="valor_acao" onkeyup="porcent();" data-validation="required"/>
                <input type="hidden" name="valor_acao" id="val_acao">
              </div>
