				...
				<div class="col-sm-12">
					...
					<div class="row">
						...
						<div class="col-sm-10 form-group">
							...
							<select class="form-control single-select cliente pessoa" name="id_parte[]" data-validation="required" id="c{{$index}}">
					...
					<!-- <input type="hidden" name="id_responsavel[]" value="{{$values->id_responsavel}}" id="c{{$index}}a"> -->
					<div class="row c{{$index}}">
						<div class="col-sm-10 form-group">
							...
							<select class="form-control single-select" name="id_responsavel[]" data-validation="required" >
								...
								@foreach($pessoaFisica as $pf)
								@if( $pf->id_parte !== $values->id_responsavel)
				...
				<div class="row">
					<div class="col-sm-12">
						...
						<div class="row">
							...
							<div class="col-sm-10 form-group">
								<label>Cliente<span class="asterisk">*</span></label>
								<select class="form-control single-select pessoa cliente" name="id_parte[]" data-validation="required" id="cp{{$ind}}">
						...
						<div class="row cp{{$ind}} partesProcesso">
							<div class="col-sm-10 form-group">
								<label>Responsável do processo</label>
								<select class="form-control single-select" name="id_responsavel[]" data-validation="required" >
									<option value="{{$values->id_responsavel}}" selected>{{$value->nome}}</option>
									<option value="">Selecione</option>
									@foreach($pessoaFisica as $pf)
									@if( $pf->id_parte !== $value->id_responsavel)
									<option value="{{$pf->id_parte}}">{{$pf->nome}}</option>
									@endif
									@endforeach
								</select>
						...
						<div class="col-sm-12">
							<div class="row" >
								<div class="col-sm-10 form-group">
									...
									<select class="form-control single-select pessoa adversa" name="id_parte[]" data-validation="required" id="a{{$index}}">
										<option value="{{$values->id_parte}}" selected class="pj">{{$values->razao_social}}</option>
										<optgroup label="Pessoa Jurídica">  
											@foreach($pessoaJuridica as $pj)
											@if( $pj->id_parte !== $values->id_parte)
						...
						<div class="row">
							<div class="col-sm-12">
								...
								<div class="row">
									<div class="col-sm-10 form-group">
										<label>Parte adversa<span class="asterisk">*</span></label>
										<select class="form-control single-select pessoa adversa" name="id_parte[]" data-validation="required" id="ap{{$ind}}">
											<option value="{{$value->id_parte}}" selected class="pf">{{$value->nome}}</option>
											<optgroup label="Pessoa Jurídica">  
												@foreach($pessoaJuridica as $pj)
												<option value="{{$pj->id_parte}}" class="pj">{{$pj->razao_social}}</option>
									...
									<div class="row ap{{$index}} partesProcesso">
							<div class="col-sm-10 form-group">
								<label>Responsável do processo</label>
								<select class="form-control single-select" name="id_responsavel[]" data-validation="required" >
									<option value="{{$values->id_responsavel}}" selected>{{$value->nome}}</option>
...
var x=10;  
var n = {{$pessoaJuridicaCount}}-({{$pessoaJuridicaCount}}-2);
