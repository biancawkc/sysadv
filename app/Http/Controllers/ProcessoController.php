...
class ProcessoController extends Controller
{
	...
	public function show($id)
	{
		...
		/*			$pessoaJuridicaC = \DB::table('parte_tem_processo')
					...
					->leftJoin('endereco', 'parte_tem_processo.id_parte','=','endereco.id_parte')
					->join('parte','parte_tem_processo.id_parte', '=', 'parte.id_parte')
					->where([
...
/*
                                ...
                                ->join('estado_civil','pessoa_fisica.id_estado_civil', '=', 'estado_civil.id_estado_civil')
                                ->leftJoin('endereco', 'parte_tem_processo.id_parte','=','endereco.id_parte')
                                ->join('parte','parte_tem_processo.id_parte', '=', 'parte.id_parte')
                                ->leftJoin('profissao','pessoa_fisica.id_profissao', '=', 'profissao.id_profissao')
                                ->where([
                                	['parte_tem_processo.id_processo', '=', $id],
                                	['parte_tem_processo.participacao', '=', 'c'],
                                	])
				...
				/*$clientes = \DB::table('parte_tem_processo')
				->where([
					['parte_tem_processo.id_processo', '=', $id],
					['parte_tem_processo.participacao', '=', 'c'],
					])->count();*/
